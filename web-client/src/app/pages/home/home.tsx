...
import styles from "./home.module.css"; // custom class import
  ...
  return (
    <div className="flex flex-col items-center w-full bg-white text-[#1D203E]">
      ...
      <div className={styles.topBar}>
        <Image src="/signed.png" alt="SignEd Logo" width={319} height={84} />
      ...
      <div className={styles.heroContainer}>
        ...
        <Button className={styles.heroButton}>SignEd Learning Software </Button>
