 ...
 */
export const SidebarItem: React.FC<SidebarItemProps> = ({label, active, icon, action, type}) => {
    ...
    return (
        <div className={"m-2 pt-1 pb-1 pl-2 pr-2 rounded-md flex items-center select-none " + style + hoverStyle} onClick={action}>
